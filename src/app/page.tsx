    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl font-bold tracking-tight">Welcome to MailGenius</CardTitle>
          <CardDescription>Your AI-powered email marketing assistant.</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-center text-muted-foreground">
            Generate funny, meme-filled emails that your customers will actually read. Upload your data and let our AI work its magic.
          </p>
        </CardContent>
        <CardFooter>
          <Button onClick={handleLogin} className="w-full" size="lg" disabled={isLoggingIn}>
            {isLoggingIn ? (
